...
public class Util {
        ...
        public void initializedDataBase() {
          ...
          //  roleService.save(new Role("ROLE_USER"));
            ...
            userService.save(new User("Zolla", "zolla@gmail.ru", "100", adminRole));
            userService.save(new User("Fabio",  "fabio@gmail.ru","100", userRole));
            userService.save(new User("Aria",  "aria@gmail.com","100", allRoles));
        }
}
